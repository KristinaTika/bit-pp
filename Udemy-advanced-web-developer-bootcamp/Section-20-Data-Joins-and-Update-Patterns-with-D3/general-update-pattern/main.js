...
add.on("click", function () {
 ...
 /* step 1*/ var listItems = d3.select("#quotes") // to update a list, we have to select a parent element first, a list, and then add new quotes. Otherwise it will be appended to HTML, not the list.
    .selectAll("li") // and then select all LI elements
    .data(quotes);
  ...
  listItems
      ...
      .merge(listItems) // we're merging new and old quotes, and now we're styling them
        .style("color", "#5599ff")
  add.remove();
});
