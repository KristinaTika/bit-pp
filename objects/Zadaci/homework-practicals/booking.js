...
(function(){
    ...
    Address.prototype.getAddressData = function(){
        ...
        return output = this.street + " " + this.number + ", " + this.postalCode + " " + this.city + ", " + this.country.slice(0, 2).toUpperCase(); 
    }
    ...
    var ja = new Address("Nemanjina", 4, 11000, "Beograd", "Srbija");
    console.log(ja.getAddressData());
})()
